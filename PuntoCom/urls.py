...
from .views import home, contacto, servicios, gasfiteria, fosaseptica, obrasmenores, quienesomos, addservicio,eliminarServicio,mensajeRespuesta,mensajeRespuestaComun
